...
import com.example.userconsumer.adapter.ListUserAdapter
import com.example.userconsumer.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), ListUserAdapter.DataClickCallback{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "User Consumer App"
