...
class FollowingViewModel: ViewModel() {
    ...
    fun setUserFollowing(getUser: String?, context: Context) {

        val listUserFollowing = ArrayList<User>()
        val token = "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"
        val url = "https://api.github.com/users/$getUser/following"
        ...
        client.get(url, object : AsyncHttpResponseHandler() {
            override fun onSuccess(statusCode: Int, headers: Array<Header>, responseBody: ByteArray) {
                try {
                    ...
                    userFollowing.postValue(listUserFollowing)
                } catch (e: Exception) {
